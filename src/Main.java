public class Main {
    public static void main(String[] args) {
        ...
        long twentyBitNumber = 707106;
        long fourtyBitNumber = 1188950305052L;
            int[] numbers = {104729, 1047291, 13,51}; // Example 20-bit and 40-bit numbers
            for (int num : numbers) {
                System.out.println("Is " + num + " prime? " + PrimeChecker.isPrime(num));
            }
                ...
                long startTwentyBitNumber = System.nanoTime();
                for (int i = 0; i < 100; i++) {
                    PrimeChecker.isPrime(twentyBitNumber);
                }
                long endTwentyBitNumber = System.nanoTime();
                long elapsedTimeTwentyBitNumber = ((endTwentyBitNumber - startTwentyBitNumber));
                System.out.println("Elapsed Time Prime Checker 20 Bits in nano seconds: " + (elapsedTimeTwentyBitNumber));


                long startFourtyBitNumber = System.nanoTime();
                for (int i = 0; i < 100; i++) {
                    PrimeChecker.isPrime(fourtyBitNumber);
                }
                long endFourtyBitNumber = System.nanoTime();
                long elapsedTimeFourtyBitNumber = ((endFourtyBitNumber - startFourtyBitNumber));
                System.out.println("Elapsed Time Prime Checker 40 Bits in nano seconds: " + (elapsedTimeFourtyBitNumber));
